...
public class Crystal_Skill : Skill
{
    ...
    [SerializeField] private UI_SkillTreeSlot unlockMovingCrystalButtion;
    ...
    protected override void Start()
    {
        ...
        unlockMovingCrystalButtion.GetComponent<Button>().onClick.AddListener(UnlockMovingCrystal);
    ...
    {
        if(unlockMovingCrystalButtion.unlocked)
        {
            canMoveToEnemy = true;
        }
    }
