...
public class ItemData_Equipment : ItemData
{
    ...
    [Header("Major stats")]
    public int strength;   //1 point increase damage by 1 and criy.power by 1%
    public int agility;    //1 point increase evasion by 1% crit.chance by 1%
    ...
    public override string GetDescription()
    {
        ...
        AddItemDescription(critPower, "Crip.Power");
